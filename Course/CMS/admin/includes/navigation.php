            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="posts_dropdown" class="collapse"> <!--The 'data-target' will activate encapsulated javascript components with the same id -->
                            <li>
                    ...
                    <li>
                        ...
                        <ul id="users_dropdown" class="collapse"> <!--The 'data-target' will activate encapsulated javascript components with the same id -->
                            <li>
                                <a href="#">View all posts</a>
                            </li>
                            <li>
